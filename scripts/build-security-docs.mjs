...
const DOC_METADATA = {
  'AstraPlanner-Security-AVG-Protest-Sportwear': {
    eyebrow: 'Informatiebeveiliging & AVG-verwerkingsdocument',
    title: 'Astra — Beveiliging en gegevensbescherming',
    subtitle: 'Technische en organisatorische maatregelen, doorgelicht en eerlijk benoemd.',
  ...
  'Concept-Verwerkersovereenkomst': {
    eyebrow: 'Verwerkersovereenkomst (art. 28 AVG)',
    title: 'Concept Verwerkersovereenkomst',
    subtitle: 'Schriftelijke vastlegging van de verwerkersrelatie tussen Ascentra en de opdrachtgever, conform artikel 28 AVG.',
    recipient: '`[INVULLEN: bedrijfsnaam opdrachtgever]`',
    version: '0.1 — Concept',
    date: '8 april 2026',
    classification: 'Concept ter juridische review',
  },
  'Concept-Security-Addendum': {
    eyebrow: 'Bijlage bij de Verwerkersovereenkomst',
    title: 'Concept Security Addendum',
    subtitle: 'Contractuele vastlegging van de technische en organisatorische beveiligingsmaatregelen, met opzeggingsrecht bij niet-naleving.',
    recipient: '`[INVULLEN: bedrijfsnaam opdrachtgever]`',
    version: '0.1 — Concept',
    date: '8 april 2026',
    classification: 'Concept ter juridische review',
  ...
  'DPIA-Template': {
    ...
    subtitle: 'Hergebruikbaar template voor verwerkingsverantwoordelijken om hun art. 35 AVG-verplichting in te vullen.',
    recipient: 'Verwerkingsverantwoordelijken die het Astra-platform inzetten',
    version: '1.0',
    date: '8 april 2026',
    classification: 'Hulpmiddel — vrij te gebruiken door klanten',
  },
  'ai-prompt-injection-test-catalog': {
    eyebrow: 'Adversarial test catalogus',
    title: 'AI Prompt Injection — testcatalogus',
    subtitle: 'Catalogus van adversarial prompts voor periodieke handmatige verificatie van Astra\'s AI-laag.',
    recipient: 'Intern — Ascentra security team',
    version: '1.0',
    date: '8 april 2026',
